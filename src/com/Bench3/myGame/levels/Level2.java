...
public class Level2 implements Level{
    ...
    public void drawHouse(Graphics g){
                ...
                g.drawImage(Main.f.i.tileset, 3*64, 3*64, (3+1)*64, (3+1)*64, pixCo.WOOD_WALL_TOP_X.value, pixCo.WOOD_WALL_TOP_Y.value, pixCo.WOOD_WALL_BOTTOM_X.value, pixCo.WOOD_WALL_BOTTOM_Y.value, null);
                g.drawImage(Main.f.i.tileset, 4*64, 3*64, (4+1)*64, (3+1)*64, pixCo.WOOD_WALL_TOP_X.value, pixCo.WOOD_WALL_TOP_Y.value, pixCo.WOOD_WALL_BOTTOM_X.value, pixCo.WOOD_WALL_BOTTOM_Y.value, null);
                g.drawImage(Main.f.i.tileset, 3*64, 2*64, (3+1)*64, (2+1)*64, pixCo.YELLOW_ROOF_TOP_X.value, pixCo.YELLOW_ROOF_TOP_Y.value, pixCo.YELLOW_ROOF_BOTTOM_X.value, pixCo.YELLOW_ROOF_BOTTOM_Y.value, null);
                g.drawImage(Main.f.i.tileset, 4*64, 2*64, (4+1)*64, (2+1)*64, pixCo.YELLOW_ROOF_TOP_X.value, pixCo.YELLOW_ROOF_TOP_Y.value, pixCo.YELLOW_ROOF_BOTTOM_X.value, pixCo.YELLOW_ROOF_BOTTOM_Y.value, null);
    }
